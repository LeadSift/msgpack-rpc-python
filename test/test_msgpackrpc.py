...
class TestMessagePackRPC(unittest.TestCase):
    ...
    def setup_env(self):
        ...
        self._client = msgpackrpc.Client(self._address, unpack_params=dict(encoding='utf-8'))
        return self._client;
    ...
    def test_connect_failed(self):
        ...
        client = msgpackrpc.Client(msgpackrpc.Address('localhost', port), unpack_params=dict(encoding='utf-8'))
    ...
    def test_timeout(self):
        ...
        if self.__class__.ENABLE_TIMEOUT_TEST:
            ...
            client = msgpackrpc.Client(self._address, timeout=1, unpack_params=dict(encoding='utf-8'))
